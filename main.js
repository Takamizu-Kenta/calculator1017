...
let numbersElem = document.getElementsByClassName('button is-number');

// 演算子+
let operatorAddElem = document.getElementsByClassName('button is-operator is-add').item(0);
// 演算子-
let operatorSubElem = document.getElementsByClassName('button is-operator is-sub').item(0);
// 演算子×
let operatorMultiElem = document.getElementsByClassName('button is-operator is-multi').item(0);
// 演算子÷
let operatorDivisionElem = document.getElementsByClassName('button is-operator is-division').item(0);

let equalElem = document.getElementsByClassName('button is-equal').item(0);
let acElem = document.getElementsByClassName('button is-ac').item(0);
